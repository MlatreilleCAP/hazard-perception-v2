  ...
  <div class="author-page">
    <div class="author-page-inner author-stack-sm">
      <div class="author-page-header">
        ...
        <RouterLink to="/studio/see/new" style="text-decoration: none">
      ...
      <section class="author-list-card">
        ...
        <div v-if="seeItems.length === 0" class="author-list-empty">
          ...
          <RouterLink to="/studio/see/new" class="author-list-title" style="display: inline-block; margin-top: 12px; font-weight: 500">
